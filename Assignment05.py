...
# BGilbertson, 8.8.2021, Improved documentation and user experience

# ------------------------------------------------------------------------ #
# -- Summary of the script -- Pseudocode --
# Data and declaring variables
# Processing
# Step 1: Load data into a text file, ToDoList.txt
# Step 1A: Introduce the program, read data from the text file
# Input/Output
# Step 2: Display a menu of choices
# Step 3: Allow the user to view the data in the table
# Step 4: Allow the user to enter new items in the table
# Step 5: Allow the user to remove items from the table
# Step 6: Allow the user to save the data to the text file
# Step 7: Exit the program
# Step 7A: Display data to the user and end the program
# ------------------------------------------------------------------------ #
...
print()
print("~"*60)
print("""This program allows the user to manage items in a ToDo list 
along with their priority. You may view, add, or delete ToDo
...
for row in objFile:
    ...
    dicRow = {"task": lstRow[0], "priority": lstRow[1].strip()} #establish dictionary keys
...
while (True):
    ...
    # Step 5 - Remove an item from the list/Table
        ...
        while (True):
            strRemoveTask = input("\nEnter a task to remove or 'exit' to return to the Main Menu: ")
...
# Step 7A - Display the items in the To Do list for the user and end the program
